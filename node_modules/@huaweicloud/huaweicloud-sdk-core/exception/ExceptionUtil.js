...
const ClientRequestException_1 = require("./ClientRequestException");
const ServerResponseException_1 = require("./ServerResponseException");
const ServiceResponseException_1 = require("./ServiceResponseException");
class ExceptionUtil {
    static generalException(exception) {
        var _a, _b, _c, _d;
        const { data = {}, status, message, requestId } = exception;
        const { error, error_code, error_msg, encoded_authorization_message } = data;
        const errorCode = (_a = error === null || error === void 0 ? void 0 : error.code) !== null && _a !== void 0 ? _a : error_code;
        const errorMsg = (_c = (_b = error === null || error === void 0 ? void 0 : error.message) !== null && _b !== void 0 ? _b : error_msg) !== null && _c !== void 0 ? _c : message;
        const encodedAuthorizationMessage = (_d = error === null || error === void 0 ? void 0 : error.encoded_authorization_message) !== null && _d !== void 0 ? _d : encoded_authorization_message;
